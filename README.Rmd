...
The model was trained using a large dataset of crop phenology derived from the German weather service (DWD): https://opendata.dwd.de. 
more details can be found here: DOIs
...
used covariates (daily resolution):
- minimal temperature
- maximal temperature
- mean temperature
- SPI (30-days standardized precipitation index)
- relative humidity
- global radiation
- VPD
